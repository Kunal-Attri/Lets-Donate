...
public final class DashboardItemAPosBinding implements ViewBinding {
  @NonNull
  ...
  private DashboardItemAPosBinding(@NonNull ConstraintLayout rootView, @NonNull TextView aneg,
      @NonNull TextView apos, @NonNull MaterialCardView cardViewContent, @NonNull TextView oneg,
      @NonNull TextView opos) {
  ...
  @NonNull
  public static DashboardItemAPosBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DashboardItemAPosBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dashboard_item_a_pos, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DashboardItemAPosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DashboardItemAPosBinding((ConstraintLayout) rootView, aneg, apos, cardViewContent,
          oneg, opos);
    }
