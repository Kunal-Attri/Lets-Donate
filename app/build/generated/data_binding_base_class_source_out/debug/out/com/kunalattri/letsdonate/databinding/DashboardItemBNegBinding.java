...
public final class DashboardItemBNegBinding implements ViewBinding {
  @NonNull
  ...
  private DashboardItemBNegBinding(@NonNull ConstraintLayout rootView, @NonNull TextView bneg,
  ...
  @NonNull
  public static DashboardItemBNegBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DashboardItemBNegBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dashboard_item_b_neg, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DashboardItemBNegBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DashboardItemBNegBinding((ConstraintLayout) rootView, bneg, cardViewContent, oneg);
    }
