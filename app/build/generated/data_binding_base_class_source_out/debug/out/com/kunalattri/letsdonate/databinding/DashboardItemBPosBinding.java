...
public final class DashboardItemBPosBinding implements ViewBinding {
  @NonNull
  ...
  private DashboardItemBPosBinding(@NonNull ConstraintLayout rootView, @NonNull TextView bneg,
      @NonNull TextView bpos, @NonNull MaterialCardView cardViewContent, @NonNull TextView oneg,
  ...
  @NonNull
  public static DashboardItemBPosBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DashboardItemBPosBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dashboard_item_b_pos, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DashboardItemBPosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DashboardItemBPosBinding((ConstraintLayout) rootView, bneg, bpos, cardViewContent,
          oneg, opos);
    }
